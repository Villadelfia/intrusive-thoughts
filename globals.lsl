...
string master_base = "Intrusive Thoughts Master [v3.0.5]";
string slave_base = "Intrusive Thoughts Slave [v3.0.5]";
#define VERSION_S "IT-Slave v3.0.5"
#define VERSION_M "IT-Master v3.0.5"
// 3 digits for major
// 3 digits for minor
// 3 digits for patch
// 2 digits for revision with base = 00, a = 01, b = 02...
#define VERSION_CMP "00300000500"
